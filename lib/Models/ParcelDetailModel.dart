class ParcelDetailModel {
  ...
  // int get merchantpayStatus => _merchantpayStatus;
  // set merchantpayStatus(int merchantpayStatus) =>
  ...
  set recipientPhone(String recipientPhone) => _recipientPhone = recipientPhone;
